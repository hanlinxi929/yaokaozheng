...
exports.getupload = exports.getupMyself = exports.getupContractSign = exports.getselIntroducerInfo = exports.getselIntroducer = exports.getread = exports.getorderUpBmDk = exports.getorderPay = exports.getorderBmInfo = exports.getoderYhqlist = exports.getmySelf = exports.getdelZcInvoice = exports.getapintroducer = exports.getaddZcInvoice = exports.getZcInvoice = exports.getSelMyself = exports.getNoticelist = exports.getMyorderPageList = exports.getMySubsidy = exports.getMyRefund = exports.getMyInfo = exports.getMyEdit = exports.getMyCommission = exports.getMyBrokeragelist = exports.getMyBrokerageadd = exports.getKqlist = exports.getConsult = exports.getCollectInfoDetail = exports.getAppCouponList = exports.getAddMyself = void 0;
...
var getMyInfo = function getMyInfo(data) {
  return (0, _ajax.default)("hs/api/AppUser/info", data);
};

//收益记录
exports.getMyInfo = getMyInfo;
var getMyCommission = function getMyCommission(data) {
  return (0, _ajax.default)("hs/api/commission/list", data);
};

//提现记录
exports.getMyCommission = getMyCommission;
var getMyBrokeragelist = function getMyBrokeragelist(data) {
  return (0, _ajax.default)("hs/api/Brokerage/list", data);
};

//提现
exports.getMyBrokeragelist = getMyBrokeragelist;
var getMyBrokerageadd = function getMyBrokerageadd(data) {
  return (0, _ajax.default)("hs/api/Brokerage/add", data);
};

//查询是否讯在账户信息
exports.getMyBrokerageadd = getMyBrokerageadd;
var getselIntroducer = function getselIntroducer(data) {
  return (0, _ajax.default)("hs/api/Brokerage/selIntroducer", data);
};

//修改新增银行账户
exports.getselIntroducer = getselIntroducer;
var getapintroducer = function getapintroducer(data) {
  return (0, _ajax.default)("hs/api/Brokerage/apintroducer", data);
};

//查询用户收款信息
exports.getapintroducer = getapintroducer;
var getselIntroducerInfo = function getselIntroducerInfo(data) {
  return (0, _ajax.default)("hs/api/Brokerage/selIntroducerInfo", data);
};

// 修改用户信息
exports.getselIntroducerInfo = getselIntroducerInfo;
var getMyEdit = function getMyEdit(data) {
  return (0, _ajax.default)("hs/api/AppUser/edit", data);
};

//加入我们查询
exports.getMyEdit = getMyEdit;
var getSelMyself = function getSelMyself(data) {
  return (0, _ajax.default)("hs/api/AppUser/selMyself", data);
};

//申请加入我们
exports.getSelMyself = getSelMyself;
var getAddMyself = function getAddMyself(data) {
  return (0, _ajax.default)("hs/api/AppUser/addMyself", data);
};

//驳回重新提交
exports.getAddMyself = getAddMyself;
var getupMyself = function getupMyself(data) {
  return (0, _ajax.default)("hs/api/AppUser/upMyself", data);
};

//上传图片
exports.getupMyself = getupMyself;
var getupload = function getupload(data) {
  return (0, _ajax.default)("hs/api/upload", data);
};

//我的收藏和访问点击查看浏览详情-跳转页
exports.getupload = getupload;
var getCollectInfoDetail = function getCollectInfoDetail(data) {
  return (0, _ajax.default)("hs/api/AppCollect/getCollectInfo", data);
};

//卡券
exports.getCollectInfoDetail = getCollectInfoDetail;
var getKqlist = function getKqlist(data) {
  return (0, _ajax.default)("hs/api/AppCoupon/list", data);
};

//我的退费
exports.getKqlist = getKqlist;
var getMyRefund = function getMyRefund(data) {
  return (0, _ajax.default)("hs/api/AppUser/MyRefund", data);
};

//证书补贴
exports.getMyRefund = getMyRefund;
var getMySubsidy = function getMySubsidy(data) {
  return (0, _ajax.default)("hs/api/AppUser/MySubsidy", data);
};

//订单
exports.getMySubsidy = getMySubsidy;
var getMyorderPageList = function getMyorderPageList(data) {
  return (0, _ajax.default)("hs/api/order/orderPageList", data);
};

//订单支付详情
exports.getMyorderPageList = getMyorderPageList;
var getorderBmInfo = function getorderBmInfo(data) {
  return (0, _ajax.default)("hs/api/order/orderBmInfo", data);
};

//订单支付
exports.getorderBmInfo = getorderBmInfo;
var getorderPay = function getorderPay(data) {
  return (0, _ajax.default)("hs/api/wxPay/orderPay", data);
};

//选中优惠券
exports.getorderPay = getorderPay;
var getAppCouponList = function getAppCouponList(data) {
  return (0, _ajax.default)("hs/api/AppCoupon/selectCoupon", data);
};

//订单推荐码
exports.getAppCouponList = getAppCouponList;
var getorderUpBmDk = function getorderUpBmDk(data) {
  return (0, _ajax.default)("hs/api/order/UpBmDk", data);
};

//我的订单优惠券
exports.getorderUpBmDk = getorderUpBmDk;
var getoderYhqlist = function getoderYhqlist(data) {
  return (0, _ajax.default)("hs/api/AppCoupon/oderYhqlist", data);
};

//合同签字
exports.getoderYhqlist = getoderYhqlist;
var getupContractSign = function getupContractSign(data) {
  return (0, _ajax.default)("hs/api/SignUp/upContractSign", data);
};

//查看是否存在已申请发票
exports.getupContractSign = getupContractSign;
var getZcInvoice = function getZcInvoice(data) {
  return (0, _ajax.default)("hs/api/SignUp/getZcInvoice", data);
};

//申请开票
exports.getZcInvoice = getZcInvoice;
var getaddZcInvoice = function getaddZcInvoice(data) {
  return (0, _ajax.default)("hs/api/SignUp/addZcInvoice", data);
};

//取消开票
exports.getaddZcInvoice = getaddZcInvoice;
var getdelZcInvoice = function getdelZcInvoice(data) {
  return (0, _ajax.default)("hs/api/SignUp/delZcInvoice", data);
};

//咨询列表
exports.getdelZcInvoice = getdelZcInvoice;
var getConsult = function getConsult(data) {
  return (0, _ajax.default)("hs/api/order/getConsult", data);
};

//我的
exports.getConsult = getConsult;
var getmySelf = function getmySelf(data) {
  return (0, _ajax.default)("hs/api/AppUser/mySelf", data);
};

//消息
exports.getmySelf = getmySelf;
var getNoticelist = function getNoticelist(data) {
  return (0, _ajax.default)("hs/api/Notice/list", data);
};

//消息阅读修改
exports.getNoticelist = getNoticelist;
var getread = function getread(data) {
  return (0, _ajax.default)("hs/api/Notice/read", data);
};
...
/***/ 173:
/*!***************************************!*\
  !*** F:/uniapp微信小程序fang/api/login.js ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.toRegister = exports.toLogin = exports.getykInfo = exports.getYkmySelf = exports.getPhone = exports.getOpenId = void 0;
var _ajax = _interopRequireDefault(__webpack_require__(/*! ../common/ajax.js */ 33));
var _configDefault = __webpack_require__(/*! @/common/config.default.js */ 60);
/**
 * 封装代办相关请求模块
...
// 登录
var toLogin = function toLogin(data) {
  return (0, _ajax.default)("hs/api/login", data);
};

//注册
exports.toLogin = toLogin;
var toRegister = function toRegister(data) {
  return (0, _ajax.default)("hs/api/register", data);
};

// 获取openid
exports.toRegister = toRegister;
var getOpenId = function getOpenId(data) {
  return (0, _ajax.default)("api/wanlshop.user/third", data);
};

// 获取手机号
exports.getOpenId = getOpenId;
var getPhone = function getPhone(data) {
  return (0, _ajax.default)("api/wanlshop.user/phone", data);
};

// 易考列表
exports.getPhone = getPhone;
var getYkmySelf = function getYkmySelf(data) {
  return (0, _ajax.default)("hs/api/homeSetting/ykList", data);
};

//易考详情
exports.getYkmySelf = getYkmySelf;
var getykInfo = function getykInfo(data) {
  return (0, _ajax.default)("hs/api/homeSetting/ykInfo", data);
};
exports.getykInfo = getykInfo;
...
/***/ 33:
/*!*****************************************!*\
  !*** F:/uniapp微信小程序fang/common/ajax.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = void 0;
var _js_sdk = _interopRequireDefault(__webpack_require__(/*! @/uni_modules/u-ajax/js_sdk */ 34));
var _configDefault = __webpack_require__(/*! @/common/config.default.js */ 60);
var instance = _js_sdk.default.create({
  baseURL: _configDefault.baseUrl,
  method: "POST",
  header: {
...
/***/ 34:
/*!*************************************************************!*\
  !*** F:/uniapp微信小程序fang/uni_modules/u-ajax/js_sdk/index.js ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = void 0;
var _Ajax = _interopRequireDefault(__webpack_require__(/*! ./lib/core/Ajax */ 35));
...
/***/ 35:
/*!*********************************************************************!*\
  !*** F:/uniapp微信小程序fang/uni_modules/u-ajax/js_sdk/lib/core/Ajax.js ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _createClass2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/createClass */ 24));
var _defineProperty2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ 11));
var _InterceptorManager = _interopRequireDefault(__webpack_require__(/*! ./InterceptorManager */ 39));
var _Request = _interopRequireDefault(__webpack_require__(/*! ../adapters/Request */ 40));
var _detachConfig2 = _interopRequireDefault(__webpack_require__(/*! ../helpers/detachConfig */ 47));
var _mergeConfig = _interopRequireDefault(__webpack_require__(/*! ../helpers/mergeConfig */ 50));
var _originURL = _interopRequireDefault(__webpack_require__(/*! ../helpers/originURL */ 51));
var _dispatchRequest = _interopRequireDefault(__webpack_require__(/*! ./dispatchRequest */ 52));
var _handleCancel = __webpack_require__(/*! ./handleCancel */ 57);
var _defaults = _interopRequireWildcard(__webpack_require__(/*! ../defaults */ 55));
...
var Ajax = /*#__PURE__*/function () {
  function Ajax(_config) {
    ...
    (0, _defineProperty2.default)(this, "request", function () {
      // 分类请求参数
      var _detachConfig = _detachConfig2.default.apply(void 0, arguments),
        callback = _detachConfig.callback,
        config = _detachConfig.config;
      ...
      // 将请求拦截遍历添加到链前面
      _this.request.interceptors.request.forEach.desc(function (_ref) {
      ...
      // 将响应拦截遍历添加到链后面
      _this.request.interceptors.response.forEach.asc(function (_ref2) {
    ...
    // 挂载修改 config 方法
    this.request.config = /*#__PURE__*/function () {
      var _ref4 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(fn) {
        return _regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return fn(_this._config);
              case 2:
                return _context2.abrupt("return", _this.config = _context2.sent);
              case 3:
              case "end":
    ...
    (0, _utils.forEach)(_defaults.METHOD, function (method) {
      _this.request[method] = function (url, data, config) {
        return _this.request.apply(_this, (0, _toConsumableArray2.default)(typeof url === 'string' ? [url, data, _objectSpread(_objectSpread({}, config), {}, {
          method: method
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return _this.config;
            case 2:
              _context3.t0 = _context3.sent.baseURL;
              if (_context3.t0) {
                _context3.next = 5;
                break;
              }
              _context3.t0 = '';
            case 5:
              _this.request.baseURL = _context3.t0;
              _this.request.origin = (0, _originURL.default)(_this.request.baseURL);
            case 7:
            case "end":
  ...
  (0, _createClass2.default)(Ajax, [{
    ...
    set: function set(config) {
      this._config = typeof config === 'function' ? /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee4() {
        return _regenerator.default.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.t0 = _mergeConfig.default;
                _context4.t1 = _defaults.default;
                _context4.next = 4;
                return config();
              case 4:
      ...
      })) : (0, _mergeConfig.default)(_defaults.default, config);
    }
  }]);
  return Ajax;
}();
...
/***/ 39:
/*!***********************************************************************************!*\
  !*** F:/uniapp微信小程序fang/uni_modules/u-ajax/js_sdk/lib/core/InterceptorManager.js ***!
  \***********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 40:
/*!****************************************************************************!*\
  !*** F:/uniapp微信小程序fang/uni_modules/u-ajax/js_sdk/lib/adapters/Request.js ***!
  \****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = RequestConstructor;
var _classCallCheck2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ 23));
var _createClass2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/createClass */ 24));
var _inherits2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/inherits */ 41));
var _possibleConstructorReturn2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/possibleConstructorReturn */ 42));
var _getPrototypeOf2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/getPrototypeOf */ 44));
var _wrapNativeSuper2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/wrapNativeSuper */ 45));
var _defineProperty2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ 11));
...
function RequestConstructor() {
  var _class;
  return _class = /*#__PURE__*/function (_Promise) {
    (0, _inherits2.default)(Request, _Promise);
    ...
    (0, _createClass2.default)(Request, [{
      ...
      function onHeadersReceived(fn) {
        if (typeof fn === 'function') {
          Request.onHeadersReceivedCallback = fn;
        }
        if (Request.onHeadersReceivedCallback && Request.task) {
          var _Request$task$onHeade, _Request$task2;
          (_Request$task$onHeade = (_Request$task2 = Request.task).onHeadersReceived) === null || _Request$task$onHeade === void 0 ? void 0 : _Request$task$onHeade.call(_Request$task2, Request.onHeadersReceivedCallback);
        }
      }
      ...
      value: function offHeadersReceived(fn) {
        ...
        if (Request.offHeadersReceivedCallback && Request.task) {
          var _Request$task$offHead, _Request$task3;
          (_Request$task$offHead = (_Request$task3 = Request.task).offHeadersReceived) === null || _Request$task$offHead === void 0 ? void 0 : _Request$task$offHead.call(_Request$task3, Request.offHeadersReceivedCallback);
        }
      }
    }]);
    return Request;
  }( /*#__PURE__*/(0, _wrapNativeSuper2.default)(Promise)), (0, _defineProperty2.default)(_class, "task", null), (0, _defineProperty2.default)(_class, "aborted", false), (0, _defineProperty2.default)(_class, "onHeadersReceivedCallback", null), (0, _defineProperty2.default)(_class, "offHeadersReceivedCallback", null), _class;
}
...
var _typeof = __webpack_require__(/*! ./typeof.js */ 13)["default"];
var assertThisInitialized = __webpack_require__(/*! ./assertThisInitialized.js */ 43);
...
var getPrototypeOf = __webpack_require__(/*! ./getPrototypeOf.js */ 44);
var setPrototypeOf = __webpack_require__(/*! ./setPrototypeOf.js */ 16);
var isNativeFunction = __webpack_require__(/*! ./isNativeFunction.js */ 46);
...
/***/ 47:
/*!********************************************************************************!*\
  !*** F:/uniapp微信小程序fang/uni_modules/u-ajax/js_sdk/lib/helpers/detachConfig.js ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = detachConfig;
var _defineProperty2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ 11));
var _typeof2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/typeof */ 13));
var _isCallback = _interopRequireDefault(__webpack_require__(/*! ./isCallback */ 48));
var _utils = __webpack_require__(/*! ../utils */ 49);
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { (0, _defineProperty2.default)(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
/**
...
function detachConfig(url, data, config) {
  ...
  // 是否传入单个参数
  var isSingle = (0, _typeof2.default)(url) === 'object';
...
/***/ 50:
/*!*******************************************************************************!*\
  !*** F:/uniapp微信小程序fang/uni_modules/u-ajax/js_sdk/lib/helpers/mergeConfig.js ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 51:
/*!*****************************************************************************!*\
  !*** F:/uniapp微信小程序fang/uni_modules/u-ajax/js_sdk/lib/helpers/originURL.js ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 52:
/*!********************************************************************************!*\
  !*** F:/uniapp微信小程序fang/uni_modules/u-ajax/js_sdk/lib/core/dispatchRequest.js ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _combineURL = _interopRequireDefault(__webpack_require__(/*! ../helpers/combineURL */ 54));
var _isCallback = _interopRequireDefault(__webpack_require__(/*! ../helpers/isCallback */ 48));
var _utils = __webpack_require__(/*! ../utils */ 49);
var _defaults = __webpack_require__(/*! ../defaults */ 55);
/**
 * 派发请求方法
 * @param {*} Request 请求类
...
/***/ 53:
/*!****************************************************************************!*\
  !*** F:/uniapp微信小程序fang/uni_modules/u-ajax/js_sdk/lib/helpers/buildURL.js ***!
  \****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 54:
/*!******************************************************************************!*\
  !*** F:/uniapp微信小程序fang/uni_modules/u-ajax/js_sdk/lib/helpers/combineURL.js ***!
  \******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 55:
/*!********************************************************************!*\
  !*** F:/uniapp微信小程序fang/uni_modules/u-ajax/js_sdk/lib/defaults.js ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _http = _interopRequireDefault(__webpack_require__(/*! ./adapters/http */ 56));
var _utils = __webpack_require__(/*! ./utils */ 49);
...
/***/ 56:
/*!*************************************************************************!*\
  !*** F:/uniapp微信小程序fang/uni_modules/u-ajax/js_sdk/lib/adapters/http.js ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 57:
/*!*****************************************************************************!*\
  !*** F:/uniapp微信小程序fang/uni_modules/u-ajax/js_sdk/lib/core/handleCancel.js ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _objectWithoutProperties2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/objectWithoutProperties */ 58));
var _excluded = ["__CANCEL__"];
/**
...
function interceptCancel(rejected) {
  ...
  return rejected && function (response) {
    return response.__CANCEL__ ? Promise.reject(response) : rejected(response);
  };
}
...
function detachCancel(_ref) {
  var __CANCEL__ = _ref.__CANCEL__,
    error = (0, _objectWithoutProperties2.default)(_ref, _excluded);
...
var objectWithoutPropertiesLoose = __webpack_require__(/*! ./objectWithoutPropertiesLoose.js */ 59);
...
/***/ 60:
/*!***************************************************!*\
  !*** F:/uniapp微信小程序fang/common/config.default.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.imgUrl = exports.baseUrl = void 0;
// 配置请求地址
// const baseUrl = "https://www.isdxy.com/";
var baseUrl = "https://www.rzjswy.cn/";
exports.baseUrl = baseUrl;
var imgUrl = "https://www.rzjswy.cn/icon/";
//   console.log("开发环境");
//   // wx51fe389a9dbcb7cb
//   console.log("生产环境");
//   // wxb6b698f86e5316be
...
/***/ 67:
/*!***************************************!*\
  !*** F:/uniapp微信小程序fang/api/index.js ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
//轮播图
var gethomeSetting = function gethomeSetting(data) {
  return (0, _ajax.default)("hs/api/homeSetting/list", data);
};
...
var getwkxx = function getwkxx(data) {
  return (0, _ajax.default)("hs/api/Learning/wkxx", data);
};

//收藏
exports.getwkxx = getwkxx;
var getAddCollect = function getAddCollect(data) {
  return (0, _ajax.default)("hs/api/AppCollect/addCollect", data);
};

//取消收藏
exports.getAddCollect = getAddCollect;
var getDelCollect = function getDelCollect(data) {
  return (0, _ajax.default)("hs/api/AppCollect/delCollect", data);
};

//收藏或浏览记录列表
exports.getDelCollect = getDelCollect;
var getCollectByUserId = function getCollectByUserId(data) {
  return (0, _ajax.default)("hs/api/AppCollect/getCollectByUserId", data);
};

//首页二级列表
exports.getCollectByUserId = getCollectByUserId;
var getQualificationList = function getQualificationList(data) {
  return (0, _ajax.default)("hs/api/homePage/QualificationList", data);
};

//资格考试二级列表
exports.getQualificationList = getQualificationList;
var getzgQualificationList = function getzgQualificationList(data) {
  return (0, _ajax.default)("hs/api/QualificationCertificate/list", data);
};

//获取tab
exports.getzgQualificationList = getzgQualificationList;
var getTwoType = function getTwoType(data) {
  return (0, _ajax.default)("hs/api/homePage/getTwoType", data);
};

//资格考试获取tab
exports.getTwoType = getTwoType;
var getzgTwoType = function getzgTwoType(data) {
  return (0, _ajax.default)("hs/api/QualificationCertificate/tabList", data);
};

//省下拉数据
exports.getzgTwoType = getzgTwoType;
var getCity = function getCity(data) {
  return (0, _ajax.default)("hs/api/homePage/getCity", data);
};

//学校详情 
exports.getCity = getCity;
var getDetailInfo = function getDetailInfo(data) {
  return (0, _ajax.default)("hs/api/homePage/getInfo", data);
};

//资格考试学校详情
exports.getDetailInfo = getDetailInfo;
var getzgDetailInfo = function getzgDetailInfo(data) {
  return (0, _ajax.default)("hs/api/QualificationCertificate/getInfo", data);
};

//高考省份列表
exports.getzgDetailInfo = getzgDetailInfo;
var getCityList = function getCityList(data) {
  return (0, _ajax.default)("hs/api/VoluntaryTest/getCitys", data);
};

//点击咨询页面详情
exports.getCityList = getCityList;
var getAddOrder = function getAddOrder(data) {
  return (0, _ajax.default)("hs/api/order/add", data);
};

//资格考试点击咨询页面详情
exports.getAddOrder = getAddOrder;
var getzgAddOrder = function getzgAddOrder(data) {
  return (0, _ajax.default)("hs/api/order/add", data);
};

//zhifu\
exports.getzgAddOrder = getzgAddOrder;
var getMiniAppPay = function getMiniAppPay(data) {
  return (0, _ajax.default)("hs/api/wxPay/miniAppPay", data);
};

//下拉属性
exports.getMiniAppPay = getMiniAppPay;
var getSxlist = function getSxlist(data) {
  return (0, _ajax.default)("hs/api/Attribute/list", data);
};

//报名学制下拉
exports.getSxlist = getSxlist;
var getXlType = function getXlType(data) {
  return (0, _ajax.default)("hs/api/Attribute/XlType", data);
};

//咨询-推荐码/优惠券-修改
exports.getXlType = getXlType;
var getUpReferralCode = function getUpReferralCode(data) {
  return (0, _ajax.default)("hs/api/order/UpReferralCode", data);
};

//咨询-推荐码/优惠券-修改资格考试
exports.getUpReferralCode = getUpReferralCode;
var getzgUpReferralCode = function getzgUpReferralCode(data) {
  return (0, _ajax.default)("hs/api/order/UpReferralCode", data);
};

//资格考试报名地区
exports.getzgUpReferralCode = getzgUpReferralCode;
var getVoluntaryTest = function getVoluntaryTest(data) {
  return (0, _ajax.default)("hs/api/VoluntaryTest/getCitys", data);
};

//报名-新增
exports.getVoluntaryTest = getVoluntaryTest;
var getSignUpadd = function getSignUpadd(data) {
...
//查询之前有米有填写，去开课
exports.getWangkeInfo = getWangkeInfo;
var getWanggetInfo = function getWanggetInfo(data) {
  return (0, _ajax.default)("hs/api/CourseInformation/getInfo", data);
};

//去开课四级联动
exports.getWanggetInfo = getWanggetInfo;
var getWangldlist = function getWangldlist(data) {
  return (0, _ajax.default)("hs/api/Attribute/XlType", data);
};

//开课支付
exports.getWangldlist = getWangldlist;
var getWangAdd = function getWangAdd(data) {
  return (0, _ajax.default)("hs/api/CourseInformation/add", data);
};

//上传简历
exports.getWangAdd = getWangAdd;
var getSignUpAdd = function getSignUpAdd(data) {
  return (0, _ajax.default)("hs/api/SignUp/add", data);
};
...
//就业服务类详情
exports.getSignUpAdd = getSignUpAdd;
var gethomePagegetInfo = function gethomePagegetInfo(data) {
  return (0, _ajax.default)("hs/api/homePage/getInfo", data);
};

//考试资料
exports.gethomePagegetInfo = gethomePagegetInfo;
var getLearningkszl = function getLearningkszl(data) {
  return (0, _ajax.default)("hs/api/Learning/kszl", data);
};

//考试资料详情
exports.getLearningkszl = getLearningkszl;
var getLearningkszlInfo = function getLearningkszlInfo(data) {
  return (0, _ajax.default)("hs/api/Learning/kszlInfo", data);
};

//新增高考规划
exports.getLearningkszlInfo = getLearningkszlInfo;
