...
var _ajax = _interopRequireDefault(__webpack_require__(/*! ./common/ajax */ 33));
...
var msg = function msg(title) {
  ...
  var icon = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : "none";
  //统一提示方便全局修改
...
var toPage = function toPage(path) {
  var root = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "pages";
  uni.navigateTo({
    url: "/".concat(root, "/").concat(path)
  });
};
var toPageA = function toPageA(path) {
  var root = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "packageA";
  uni.navigateTo({
    url: "/".concat(root, "/").concat(path)
  });
};
var toPackPage = function toPackPage(path, root) {
  uni.navigateTo({
    url: "/".concat(root, "/").concat(path)
  });
};
...
// 跳转到switchTab
var toTab = function toTab(path) {
  uni.switchTab({
    url: "/pages/".concat(path)
  });
};
var toReLaunch = function toReLaunch(path) {
  var root = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "pages";
  uni.reLaunch({
    url: "/page/".concat(path)
  });
};
...
_vue.default.prototype.$baseUrl = _configDefault.baseUrl;
...
_vue.default.prototype.$needLogin = function () {
  uni.showToast({
    title: "请登录后操作~",
    icon: "none",
    duration: 500,
...
/***/ 28:
/*!***********************************************************!*\
  !*** F:/uniapp微信小程序fang/App.vue?vue&type=script&lang=js& ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 29:
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--13-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!F:/uniapp微信小程序fang/App.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  onLaunch: function onLaunch() {
    ...
    if (obj.scene == 1047 || obj.scene == 1048 || obj.scene == 1049) {
      if (obj.query.scene) {
        var productId = decodeURIComponent(obj.query.scene);
        if (true) {
          console.log("开发环境：" + obj.query.scene);
          if (productId != undefined) {
            this.$api.redirectTo("product/index?".concat(productId));
          }
        } else {}
      }
    }
...
/***/ 30:
/*!********************************************************************!*\
  !*** F:/uniapp微信小程序fang/App.vue?vue&type=style&index=0&lang=scss& ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 31:
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--8-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--8-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-2!./node_modules/postcss-loader/src??ref--8-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/sass-loader/dist/cjs.js??ref--8-oneOf-1-4!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-5!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!F:/uniapp微信小程序fang/App.vue?vue&type=style&index=0&lang=scss& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
