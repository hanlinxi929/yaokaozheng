<template>
<uni-shadow-root class="vant-weapp-tab-index"><view :class="'custom-class custom-class22 '+(utils.bem('tab__pane', { active, inactive: !active }))" :style="shouldShow ? '' : 'display: none;'">
